...
static async Task SmartContractsDeploymentAsync()
{
    ...
    var url2 = "http://testchain.nethereum.com:8545";

    var privateKey2 = "0x7580e7fb49df1c861f0050fae31c2224c6aba908e116b8da44ee8cd927b990b0";

    var account2 = new Account(privateKey);
    ...
    var deploymentMessage2 = new StandardTokenDeployment
    {
        TotalSupply = 100000
    };
    ...
    var deploymentHandler2 = web3.Eth.GetContractDeploymentHandler<StandardTokenDeployment>();

    var transactionReceipt = await deploymentHandler.SendRequestAndWaitForReceiptAsync(deploymentMessage);

    var contractAddress2 = transactionReceipt.ContractAddress;
